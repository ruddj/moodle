...
/**
 * Strings for component 'theme_shsiii', language 'en'
 *
 * @package   theme_shsiii
 * @copyright 2011
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
$string['configtitle'] = 'shsiii Custom Settings';
$string['pluginname'] = 'shsiii';
...
<div class="clearfix">
 <div class="theme_screenshot">
  ...
  <h2>shsiii</h2>
  <img src="shsiii/pix/screenshot.jpg" />
 ...
 <div class="theme_description">
  <h2>About</h2>
  <p>shsiii is a three-column, fluid-width theme coded for Moodle 2.0. It makes use of custom menus that appear below the site title on every page. An added function, which allows users to login and logout, has now been integrated into the custom menu for this theme.</p>
  <h2>Parents</h2>
