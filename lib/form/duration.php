...
class MoodleQuickForm_duration extends MoodleQuickForm_group {
    ...
    */
    ...
    function _createElements() {
        ...
        $this->_elements[] = $this->createElement('text', 'number', get_string('time', 'form'), $attributes, true);
        unset($attributes['size']);
        $this->_elements[] = $this->createElement('select', 'timeunit', get_string('timeunit', 'form'), $this->get_units(), $attributes, true);
