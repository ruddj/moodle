...
if ($ADMIN->fulltree) {
    ...
    if (!during_initial_install()) {
        ...
        $settings->add(new admin_setting_configcheckbox('enrol_meta/addmultiple',
          get_string('addmultiple', 'enrol_meta'), get_string('addmultiple_desc', 'enrol_meta'), 1));
        $settings->add(new admin_setting_configtext('enrol_meta/addmultiple_rowlimit',
          get_string('addmultiple_rowlimit', 'enrol_meta'), get_string('addmultiple_rowlimit_desc', 'enrol_meta'), 250, PARAM_INT));
